...
public class FPSCounter : MonoBehaviour
{
    ...
    void UpdateBuffer()
    {
        ...
        // it is better to use unscaled delta time because it always gives the time that took to process the last frame
        // delta time on the other hand is affected by the time settings
